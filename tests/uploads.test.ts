import fs from 'fs';
import type { ResponseLike } from 'comicstockmcp/internal/to-file';
import { toFile } from 'comicstockmcp/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('comicstockmcp/core/uploads');
    await expect(
