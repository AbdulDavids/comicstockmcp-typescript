...
import { ClientOptions } from 'comicstockmcp';

const prompt = `Runs JavaScript code to interact with the Comic Stock API.
...
const localDenoHandler = async ({
  ...
  try {
    const sdkPkgName = 'comicstockmcp';
